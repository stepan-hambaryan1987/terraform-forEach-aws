...
resource "aws_subnet" "public-subnet" {
  ...
  availability_zone       = element(data.aws_availability_zones.available.names, index(keys(var.public_subnets_ciders), each.key))
...
resource "aws_subnet" "private-subnet" {
  ...
  availability_zone       = element(data.aws_availability_zones.available.names, index(keys(var.private_subnets_ciders), each.key))
